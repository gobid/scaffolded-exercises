...
let stateManager = {"Program:eventPos:e":[null,null],"Program:Map:$container":[null,null],"Program:Map:$overlay":[null,null],"Program:Map:sign:x":[null,null],"Program:Map:pow:x":[null,null],"Program:Map:pow:y":[null,null],"Program:Map:clamp:x":[null,null],"Program:Map:clamp:min":[null,null],"Program:Map:clamp:max":[null,null],"Program:Map:offset":[null,null],"Program:Map:padding_top":[null,null],"Program:Map:size":[null,null],"Program:Map:tilesize":[null,null],"Program:Map:visible":[null,null],"Program:Map:container_size":[null,null],"Program:Map:scroll_delta":[null,null],"Program:Map:$map":[null,null],"Program:Map:map_size":[null,null],"Program:Map:position":[null,null],"Program:Map:centre":[null,null],"Program:Map:update:centre_last":[null,null],"Program:Map:update:centre":[null,null],"Program:Map:update:tile_name:x":[null,null],"Program:Map:update:tile_name:y":[null,null],"Program:Map:update:$remove":[null,null],"Program:Map:update:y":[null,null],"Program:Map:update:x":[null,null],"Program:Map:update:name":[null,null],"Program:Map:update:tile":[null,null],"Program:Map:update:$image":[null,null],"Program:Map:drag:e":[null,null],"Program:Map:drag:pos":[null,null],"Program:Map:drag:undefined":[null,null],"Program:Map:pos":[null,null],"Program:map":[null,null]}
...
const sourceCodeMap = {"eventPos:1:9":{"start":{"line":1,"column":0,"token":0},"end":{"line":9,"column":1,"token":46}},"$container.css({:12:20":{"start":{"line":12,"column":4,"token":52},"end":{"line":20,"column":7,"token":87}},"rhs-method-$overlay:22:22":{"start":{"line":22,"column":8,"token":88},"end":{"line":22,"column":45,"token":96}},"$overlay.css({:24:27":{"start":{"line":24,"column":4,"token":97},"end":{"line":27,"column":7,"token":112}},"sign:29:31":{"start":{"line":29,"column":4,"token":112},"end":{"line":31,"column":5,"token":136}},"pow:33:35":{"start":{"line":33,"column":4,"token":136},"end":{"line":35,"column":5,"token":165}},"clamp:37:39":{"start":{"line":37,"column":4,"token":165},"end":{"line":39,"column":5,"token":193}},"rhs-method-offset:41:41":{"start":{"line":41,"column":8,"token":194},"end":{"line":41,"column":36,"token":201}},"rhs-method-$map:48:48":{"start":{"line":48,"column":8,"token":254},"end":{"line":48,"column":42,"token":262}},"$map.css({:51:56":{"start":{"line":51,"column":4,"token":296},"end":{"line":56,"column":7,"token":326}},"$map.find(\".ground\").css({:60:67":{"start":{"line":60,"column":4,"token":355},"end":{"line":67,"column":7,"token":402}},"update:71:114":{"start":{"line":71,"column":4,"token":412},"end":{"line":114,"column":5,"token":751}},"$map.css({:72:75":{"start":{"line":72,"column":8,"token":417},"end":{"line":75,"column":11,"token":438}},"tile_name:80:84":{"start":{"line":80,"column":8,"token":473},"end":{"line":84,"column":9,"token":531}},"rhs-method-$remove:87:87":{"start":{"line":87,"column":16,"token":555},"end":{"line":87,"column":56,"token":567}},"rhs-method-tile:92:92":{"start":{"line":92,"column":24,"token":623},"end":{"line":92,"column":56,"token":633}},"$image.load(function() {:101:105":{"start":{"line":101,"column":24,"token":695},"end":{"line":105,"column":27,"token":733}},"$(this).show();:102:102":{"start":{"line":102,"column":28,"token":703},"end":{"line":102,"column":43,"token":712}},"$(this).remove();:104:104":{"start":{"line":104,"column":28,"token":721},"end":{"line":104,"column":45,"token":730}},"$map.append($image);:107:107":{"start":{"line":107,"column":24,"token":733},"end":{"line":107,"column":44,"token":740}},"$remove.remove();:112:112":{"start":{"line":112,"column":12,"token":743},"end":{"line":112,"column":29,"token":749}},"drag:118:136":{"start":{"line":118,"column":4,"token":755},"end":{"line":136,"column":5,"token":868}},"$container.on(\"mousedown touchstart\", function(e) {:138:147":{"start":{"line":138,"column":4,"token":868},"end":{"line":147,"column":7,"token":954}},"$(document).on(e.type == \"mousedown\" ? \"mousemove\" : \"touchmove\", drag);:145:145":{"start":{"line":145,"column":8,"token":925},"end":{"line":145,"column":80,"token":945}},"e.preventDefault();:146:146":{"start":{"line":146,"column":8,"token":945},"end":{"line":146,"column":27,"token":951}},"$(document).on(\"mouseup touchend\", function(e) {:149:152":{"start":{"line":149,"column":4,"token":954},"end":{"line":152,"column":7,"token":987}},"$(document).off(\"mousemove touchmove\", drag);:150:150":{"start":{"line":150,"column":8,"token":968},"end":{"line":150,"column":53,"token":980}}}
    /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$container.css({:12:20`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
...
/* autogen added */
        ...
        }, fxnCallCallback(`rhs-method-$overlay:22:22`, sourceCodeArr, sourceCodeMap))();
        /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$overlay.css({:24:27`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */


        
/* autogen added */
        sign = StackTrace.instrument(sign, fxnCallCallback(`sign:29:31`, sourceCodeArr, sourceCodeMap));
        /* end autogen added */
...
/* autogen added */
        pow = StackTrace.instrument(pow, fxnCallCallback(`pow:33:35`, sourceCodeArr, sourceCodeMap));
        /* end autogen added */
...
/* autogen added */
        clamp = StackTrace.instrument(clamp, fxnCallCallback(`clamp:37:39`, sourceCodeArr, sourceCodeMap));
        /* end autogen added */
...
/* autogen added */
        offset = StackTrace.instrument(() => {
            $container.offset()
        }, fxnCallCallback(`rhs-method-offset:41:41`, sourceCodeArr, sourceCodeMap))();
        /* end autogen added */
...
/* autogen added */ 
    ...
    var container_size = [$container.width(), $container.height()];
/* autogen added */ updateStateManager("Program:Map:container_size", container_size); /* end autogen added */
...
/* autogen added */
        ...
        }, fxnCallCallback(`rhs-method-$map:48:48`, sourceCodeArr, sourceCodeMap))();
        /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$map.css({:51:56`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$map.find(".ground").css({:60:67`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
...
/* autogen added */
        update = StackTrace.instrument(update, fxnCallCallback(`update:71:114`, sourceCodeArr, sourceCodeMap));
        /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$map.css({:72:75`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */

        var centre_last = centre;
/* autogen added */ updateStateManager("Program:Map:update:centre_last", centre_last); /* end autogen added */
...
/* autogen added */
        tile_name = StackTrace.instrument(tile_name, fxnCallCallback(`tile_name:80:84`, sourceCodeArr, sourceCodeMap));
        /* end autogen added */

        function tile_name(x, y) {
            x -= size[3];
/* autogen added */ updateStateManager("Program:Map:update:tile_name:x", x); /* end autogen added */

            y -= size[0];
/* autogen added */ updateStateManager("Program:Map:update:tile_name:y", y); /* end autogen added */
...
/* autogen added */
        ...
        }, fxnCallCallback(`rhs-method-$remove:87:87`, sourceCodeArr, sourceCodeMap))();
        /* end autogen added */

            var $remove = $map.children().not(".ground");
/* autogen added */ updateStateManager("Program:Map:update:$remove", $remove); /* end autogen added */
...
/* autogen added */
        tile = StackTrace.instrument(() => {
            $map.find(".tile" + name)
        }, fxnCallCallback(`rhs-method-tile:92:92`, sourceCodeArr, sourceCodeMap))();
        /* end autogen added */

/* autogen added */ updateStateManager("Program:Map:update:name", name); /* end autogen added */
...
/* autogen added */ 
            ...
            /* end autogen added */
                    ...
                    var tile = $map.find(".tile" + name);
/* autogen added */ updateStateManager("Program:Map:update:tile", tile); /* end autogen added */
...
/* autogen added */ updateStateManager("Program:Map:update:$image", $image); /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$(this).show();:102:102`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
                        }).error(function() {
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$(this).remove();:104:104`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
                        });

 }, fxnCallCallback(`$image.load(function() {:101:105`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$map.append($image);:107:107`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
                    }
                }
            }
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$remove.remove();:112:112`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
        }
    }
...
/* autogen added */
        drag = StackTrace.instrument(drag, fxnCallCallback(`drag:118:136`, sourceCodeArr, sourceCodeMap));
        /* end autogen added */
...
/* autogen added */ updateStateManager("Program:Map:drag:position", position); /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$(document).on(e.type == "mousedown" ? "mousemove" : "touchmove", drag);:145:145`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
        e.preventDefault();

 }, fxnCallCallback(`e.preventDefault();:146:146`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
    });

 }, fxnCallCallback(`$container.on("mousedown touchstart", function(e) {:138:147`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
...
/* autogen added */ 
 ...
 }, fxnCallCallback(`$(document).off("mousemove touchmove", drag);:150:150`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
        scroll_delta = null;
/* autogen added */ updateStateManager("Program:Map:scroll_delta", scroll_delta); /* end autogen added */
 ...
 }, fxnCallCallback(`$(document).on("mouseup touchend", function(e) {:149:152`, sourceCodeArr, sourceCodeMap))() 
 /* end autogen added */
};
