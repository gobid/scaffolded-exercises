...
7. Run `node createStateManager.js` changing `fileKey` var to be the filename of the main JavaScript file for the site you're working on. This creates / updates final_[example]_src.js. You should copy the final_[example]_src.js into main.js manually.
