            ...
            for (var y = -1; y <= +1; y++) {
                for (var x = -1; x <= +1; x++) {
                    ...
                    if (tile.length) {
                        ...
                        $image = $(
                            "<img class=\"img-tile tile" + name + "\" src=\"http://imgs.xkcd.com/clickdrag/" + name + ".png\" style=\"top:" + (centre[1] + y) * tilesize + "px;left:" + (centre[0] + x) * tilesize + "px; z-index: -1; position: absolute;;\" style=\"display:none\" />"
                        );
